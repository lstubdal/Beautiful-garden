<template>
	<div class="slideshow">
		...
		<div class="slideshow__extra">
			<button class="slideshow__button-caption" @click="showCaption =!showCaption"><svg width="30" height="30" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
